...
b(Methoden der Marktforschung) --- a(Primär
forschung)
b --- c(Sekundär
forschung)
...
```mermaid
graph TD
a(Aufgabenstellung Zielsetzung) --> b(Auswahl Marktforschungsmethoden)
b --> c(Stichprobenauswahl)
c --> d(Durchführung)
d --> e(Datenanalyse / -interpretation)
e --> f(Präsentation)
```
#### Datenquellen
...
```mermaid
graph LR
a(Kosten) --- b(Preisbildung)
c(Kunkurrenten) --- b(Preisbildung)
d(Nachfrage
der Kunden) --- b(Preisblidung)
b --- e(Preis-
aus-
richtung)
e --- f(Preis-
...
```mermaid
graph TD
a((Preisstrategien)) --> c[Preis-
positionierungs-
strategien]
a --> d[Preiseinführungs-
strategien]
a --> e[Taktische
Preisstrategien]
a --> f[Psychologische
...
```mermaid
graph TD
a(Wer ist die Öffentlichkeit?) --- b(Interne Öffentlichkeitsarbeit)
